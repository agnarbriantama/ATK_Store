<div class="container">
    <h1 class="text-center"> Edit Data Bolpoin </h1>
    <form method="post" action="<?= base_url('bolpoin/edit_data/' . $item->id_barang) ?>" enctype="multipart/form-data" autocomplete="off">
