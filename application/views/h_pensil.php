...
<div class="container-fluid">
  ...
  <?php echo form_open('dashboard/search') ?>
        <input type="text" name="keyword" class="form-control bg-light border-2 small" placeholder="Search">
        <button type="submit" class="btn btn-success">Search</button>
        <?php echo form_close() ?> </div>
  </form>
            <h2 class="m-0 font-weight-bold text-primary">Data Barang</h2>
            <a href="<?php echo base_url('pensil/tambah'); ?>" class="btn btn-primary btn-sm float-right">Tambah Data</a>
        </div>
        <div class="card-body">
                    ...
                    foreach ($pensil as $item) { ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('pensil/update/' . $item->id_barang) ?>" class="btn btn-small text-warning"><i class="fas fa-edit"></i> Edit</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= base_url('pensil/delete/' . $item->id_barang) ?>" class="btn btn-danger">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
