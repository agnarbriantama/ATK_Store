...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?php echo base_url('pewarna/tambah'); ?>" class="btn btn-primary btn-sm float-right">Tambah Data</a>
        </div>
        <div class="card-body">
                    ...
                    foreach ($pewarna as $item) { ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('pewarna/update/' . $item->id_barang) ?>" class="btn btn-small text-warning"><i class="fas fa-edit"></i> Edit</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= base_url('pewarna/delete/' . $item->id_barang) ?>" class="btn btn-danger">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
